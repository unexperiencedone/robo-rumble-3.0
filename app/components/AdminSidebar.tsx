...
export default function AdminSidebar() {
  ...
  return (
    <>
      ...
      <aside 
        className={`
          fixed top-0 left-0 h-full w-64 bg-black border-r border-[#FF003C]/30 z-50 transition-transform duration-300 ease-in-out
          ${isOpen ? "translate-x-0" : "-translate-x-full"}
          md:translate-x-0 md:static flex flex-col justify-between
        `}
      >
        {/* Header */}
        <div className="p-6 border-b border-[#FF003C]/20">
        ...
        {/* Footer / Logout */}
        <div className="p-4 border-t border-[#FF003C]/20">
          <button 
